...
//Show - Hide mobile-all-filters
    ...
    $('.filters .filters-wrapper .m-all-filters').click(function(){
        ...
        $('.top-navigation .navigation-left, .top-navigation .navigation-right, .car-marks, .news, footer, .reset-filters, .mob-sort, .list-item, #select-list').toggleClass('hidden-xs');
    });
